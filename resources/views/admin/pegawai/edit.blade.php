...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input class="form-control mb-3" type="text" name="nama" placeholder="Nama" value="{{$pegawai->nama}}" aria-label="default input example" required>
        </div>
        <div class="mb-3">
            <label for="formFile" class="form-label">Username</label>
            <input class="form-control mb-3" type="text" name="username" placeholder="Username" value="{{$pegawai->username}}" aria-label="default input example" required>
        </div>
        <div class="mb-3">
