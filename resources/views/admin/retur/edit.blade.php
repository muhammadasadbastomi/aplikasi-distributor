...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input class="form-control mb-3" type="text" name="nama" placeholder="Nama" value="{{$retur->nama}}" aria-label="default input example" required>
        </div>
        <div class="mb-3">
            <label for="formFile" class="form-label">Returname</label>
            <input class="form-control mb-3" type="text" name="returname" placeholder="Returname" value="{{$retur->returname}}" aria-label="default input example" required>
        </div>
        <div class="mb-3">
